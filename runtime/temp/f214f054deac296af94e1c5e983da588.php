<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"C:\Work\Code\PartyHome\public/../application/admin\view\index\index.html";i:1536636085;s:62:"C:\Work\Code\PartyHome\application\admin\view\common\meta.html";i:1536636085;s:64:"C:\Work\Code\PartyHome\application\admin\view\common\header.html";i:1536636085;s:62:"C:\Work\Code\PartyHome\application\admin\view\common\menu.html";i:1536636085;s:65:"C:\Work\Code\PartyHome\application\admin\view\common\control.html";i:1536636085;s:64:"C:\Work\Code\PartyHome\application\admin\view\common\script.html";i:1536636085;}*/ ?>
<!DOCTYPE html>
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="/partyHome/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/partyHome/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/partyHome/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/partyHome/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
