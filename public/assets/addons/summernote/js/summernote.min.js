(function (global, factory) {
    ...
    var palette = renderer.create('<div class="note-color-palette"/>', function ($node, options) {
        ...
        if (options.tooltip) {
            $node.find(".note-color-btn").tooltip({container: options.container, trigger: "hover", placement: "bottom"})
        }
    });
        ...
        button: function ($node, options) {
            return renderer.create('<button type="button" class="note-btn btn btn-default btn-sm" role="button" tabindex="-1">', function ($node, options) {
                if (options && options.tooltip) {
                    ...
                    }).tooltip({container: options.container, trigger: "hover", placement: "bottom"})
                }
            })($node, options)
        },
    ...
    var History = function () {
        ...
        History.prototype.makeSnapshot = function () {
            ...
            return {contents: this.$editable.html(), bookmark: rng ? rng.bookmark(this.editable) : emptyBookmark}
        };
